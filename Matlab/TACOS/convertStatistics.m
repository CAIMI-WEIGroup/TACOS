 ...
 function transformed_T = convertStatistics(varargin)
    ...
    if strcmp(form, 'functional')
        ...
        controlS_Path = setDefault(controlS_Path, ['S_HCP_', source_Atlas, '_FC.csv']);
        patientS_Path = setDefault(patientS_Path, ['S_HCP_', source_Atlas, '_FC.csv']);
    ...
    elseif strcmp(form, 'structural')
        ...
        patientS_Path = setDefault(patientS_Path, ['S_HCP_', source_Atlas, '_SC.csv']);
        control_S = readTxt(controlS_Path);
        patient_S = readTxt(patientS_Path);
    end
